...
MODULE_ATTR_NAMES_ES: Dict[int, str] = {
    ModuleAttrType.STRENGTH_BOOST.value: "Aumento de fuerza",
    ModuleAttrType.AGILITY_BOOST.value: "Aumento de agilidad",
    ModuleAttrType.INTELLIGENCE_BOOST.value: "Aumento de intelecto",
    ModuleAttrType.SPECIAL_ATTACK_DAMAGE.value: "Ataque especial",
    ModuleAttrType.ELITE_STRIKE.value: "Golpe de élite",
    ModuleAttrType.SPECIAL_HEALING_BOOST.value: "Aumento de curación",
    ModuleAttrType.EXPERT_HEALING_BOOST.value: "Mejora de curación",
    ModuleAttrType.CASTING_FOCUS.value: "Enfoque de lanzamiento",
    ModuleAttrType.ATTACK_SPEED_FOCUS.value: "VEL de ATQ",
    ModuleAttrType.CRITICAL_FOCUS.value: "Enfoque de crítico",
    ModuleAttrType.LUCK_FOCUS.value: "Enfoque de suerte",
    ModuleAttrType.MAGIC_RESISTANCE.value: "Resistencia",
    ModuleAttrType.PHYSICAL_RESISTANCE.value: "Armadura",
    ModuleAttrType.EXTREME_DAMAGE_STACK.value: "Acumulación de DÑO",
    ModuleAttrType.EXTREME_FLEXIBLE_MOVEMENT.value: "Agilidad",
    ModuleAttrType.EXTREME_LIFE_CONVERGENCE.value: "Condensación de Vida",
    ModuleAttrType.EXTREME_EMERGENCY_MEASURES.value: "Primeros auxilios",
    ModuleAttrType.EXTREME_LIFE_FLUCTUATION.value: "Onda Vital",
    ModuleAttrType.EXTREME_LIFE_DRAIN.value: "Robo de vida",
    ModuleAttrType.EXTREME_TEAM_CRIT.value: "Crítico y suerte grupal",
    ModuleAttrType.EXTREME_DESPERATE_GUARDIAN.value: "Protección Final",
}

MODULE_NAMES_ES: Dict[int, str] = {
    ModuleType.BASIC_ATTACK.value: "Módulo de ataque básico",
    ModuleType.HIGH_PERFORMANCE_ATTACK.value: "Módulo de ataque avanzado",
    ModuleType.EXCELLENT_ATTACK.value: "Módulo de ataque excelente",
    ModuleType.EXCELLENT_ATTACK_PREFERRED.value: "Módulo de ataque excelente preferido",
    ModuleType.BASIC_HEALING.value: "Módulo de soporte básico",
    ModuleType.HIGH_PERFORMANCE_HEALING.value: "Módulo de soporte avanzado",
    ModuleType.EXCELLENT_HEALING.value: "Módulo de soporte excelente",
    ModuleType.EXCELLENT_HEALING_PREFERRED.value: "Módulo de soporte excelente preferido",
    ModuleType.BASIC_PROTECTION.value: "Módulo de guardia básico",
    ModuleType.HIGH_PERFORMANCE_PROTECTION.value: "Módulo de guardia avanzado",
    ModuleType.EXCELLENT_PROTECTION.value: "Módulo de guardia excelente",
    ModuleType.EXCELLENT_PROTECTION_PREFERRED.value: "Módulo de guardia excelente preferido",
}
...
def to_spanish_attr(name_cn: str) -> str:
    """中文属性名转西班牙文显示名；未知则返回原文"""
    attr_id = MODULE_ATTR_IDS.get(name_cn)
    if attr_id is not None:
        return MODULE_ATTR_NAMES_ES.get(attr_id, name_cn)
    return name_cn

def to_spanish_module(config_id: int, fallback_cn: str) -> str:
    """根据 config_id 返回西班牙文模组名；未知则返回中文回退"""
    return MODULE_NAMES_ES.get(config_id, fallback_cn)
